...
_ALLOWED_WORKFLOW_TYPES: tuple[tuple[str, str], ...] = (
    ...
    ("iac_agent.providers.aws.dynamodb.contract", "DynamoDBResourceSpec"),
    ("iac_agent.providers.aws.dynamodb.contract", "DynamoDBKeySpec"),
    ("iac_agent.providers.aws.dynamodb.contract", "DynamoDBKeyType"),
    ("iac_agent.providers.aws.dynamodb.contract", "DynamoDBBillingMode"),
    ("iac_agent.providers.aws.dynamodb.contract", "DynamoDBEncryptionSpec"),
